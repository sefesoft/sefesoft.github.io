...
2. Use the "Live Server" extension to open `index.html`.
3. For PWA testing (installation prompts), use an incognito window or deploy to a service like Netlify/GitHub Pages to ensure HTTPS.
