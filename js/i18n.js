...
export const translations = {
  es: {
    ...
    "admin.loginTitle": "Acceso administrador",
    "admin.loginNote":
      "Esta consola es solo para quien administra el directorio. Los cambios (cervecerías, eventos y promociones) se guardan en este dispositivo (localStorage). Para protección real hace falta un servidor.",
    "admin.password": "Contraseña",
    "admin.badPassword": "Contraseña incorrecta.",
    "admin.loginBtn": "Entrar",
    "admin.backApp": "Volver a la app",
    "admin.consoleTitle": "Consola de gestión",
    "admin.logout": "Cerrar sesión",
    "admin.tabBreweries": "Cervecerías",
    "admin.tabEvents": "Eventos",
    "admin.tabPromos": "Promociones",
    "admin.tabsAria": "Secciones del administrador",
    "admin.breweriesTitle": "Cervecerías",
    "admin.edit": "Editar",
    "admin.remove": "Eliminar",
    "admin.removeConfirm": "¿Eliminar esta cervecería de la lista?",
    "admin.addBrewery": "Añadir cervecería",
    "admin.editBrewery": "Editar cervecería",
    "admin.emptyBreweries": "No hay cervecerías. Añade una con el formulario.",
    "admin.breweryUntitled": "Sin nombre",
    "admin.save": "Guardar",
    "admin.cancel": "Cancelar edición",
    "admin.nameEs": "Nombre (ES)",
    "admin.nameEn": "Nombre (EN)",
    "admin.logo": "URL del logo",
    "admin.gallery": "Galería (una URL por línea)",
    "admin.galleryPlaceholder": "https://…",
    "admin.addressEs": "Dirección (ES)",
    "admin.addressEn": "Dirección (EN)",
    "admin.web": "Sitio web",
    "admin.phone": "Teléfono",
    "admin.descEs": "Descripción (ES)",
    "admin.descEn": "Descripción (EN)",
    "admin.lat": "Latitud (mapa)",
    "admin.lng": "Longitud (mapa)",
    "admin.nameEsRequired": "El nombre en español es obligatorio.",
    "admin.eventsTitle": "Eventos",
    "admin.promosTitle": "Promociones",
    "admin.addEvent": "Añadir evento",
    "admin.editEvent": "Editar evento",
    "admin.emptyEvents": "No hay eventos. Añade uno con el formulario.",
    "admin.eventUntitled": "Evento sin nombre",
    "admin.removeEventConfirm": "¿Eliminar este evento?",
    "admin.addPromo": "Añadir promoción",
    "admin.editPromo": "Editar promoción",
    "admin.emptyPromos": "No hay promociones. Añade una con el formulario.",
    "admin.promoUntitled": "Promoción sin nombre",
    "admin.removePromoConfirm": "¿Eliminar esta promoción?",
    "admin.itemId": "Identificador (URL)",
    "admin.idAutoPlaceholder": "Vacío = se genera automáticamente",
    "admin.eventDate": "Fecha del evento",
    "admin.imageUrl": "URL de imagen",
    "admin.promoStart": "Inicio de vigencia",
    "admin.promoEnd": "Fin de vigencia",
    "admin.dateRequired": "Indica la fecha del evento.",
    "admin.promoDatesRequired": "Indica inicio y fin de vigencia.",
    "admin.duplicateId": "Ese identificador ya existe. Usa otro o déjalo vacío para generar uno.",
  },
  en: {
    ...
    "admin.loginNote":
      "This console is for directory admins only. Changes (breweries, events, promos) are saved on this device (localStorage). Real protection requires a backend.",
    "admin.password": "Password",
    "admin.badPassword": "Incorrect password.",
    "admin.loginBtn": "Sign in",
    "admin.backApp": "Back to app",
    "admin.consoleTitle": "Manager console",
    "admin.logout": "Log out",
    "admin.tabBreweries": "Breweries",
    "admin.tabEvents": "Events",
    "admin.tabPromos": "Promos",
    "admin.tabsAria": "Admin sections",
    "admin.breweriesTitle": "Breweries",
    "admin.edit": "Edit",
    "admin.remove": "Remove",
    "admin.removeConfirm": "Remove this brewery from the list?",
    "admin.addBrewery": "Add brewery",
    "admin.editBrewery": "Edit brewery",
    "admin.emptyBreweries": "No breweries yet. Add one using the form below.",
    "admin.breweryUntitled": "Untitled",
    "admin.save": "Save",
    "admin.cancel": "Cancel edit",
    "admin.nameEs": "Name (ES)",
    "admin.nameEn": "Name (EN)",
    "admin.logo": "Logo URL",
    "admin.gallery": "Gallery (one URL per line)",
    "admin.galleryPlaceholder": "https://…",
    "admin.addressEs": "Address (ES)",
    "admin.addressEn": "Address (EN)",
    "admin.web": "Website",
    "admin.phone": "Phone",
    "admin.descEs": "Description (ES)",
    "admin.descEn": "Description (EN)",
    "admin.lat": "Latitude (map)",
    "admin.lng": "Longitude (map)",
    "admin.nameEsRequired": "Spanish name is required.",
    "admin.eventsTitle": "Events",
    "admin.promosTitle": "Promos",
    "admin.addEvent": "Add event",
    "admin.editEvent": "Edit event",
    "admin.emptyEvents": "No events yet. Add one using the form below.",
    "admin.eventUntitled": "Untitled event",
    "admin.removeEventConfirm": "Remove this event?",
    "admin.addPromo": "Add promo",
    "admin.editPromo": "Edit promo",
    "admin.emptyPromos": "No promos yet. Add one using the form below.",
    "admin.promoUntitled": "Untitled promo",
    "admin.removePromoConfirm": "Remove this promo?",
    "admin.itemId": "ID (for URL)",
    "admin.idAutoPlaceholder": "Leave empty to auto-generate",
    "admin.eventDate": "Event date",
    "admin.imageUrl": "Image URL",
    "admin.promoStart": "Start date",
    "admin.promoEnd": "End date",
    "admin.dateRequired": "Please set the event date.",
    "admin.promoDatesRequired": "Please set both start and end dates.",
    "admin.duplicateId": "That ID already exists. Choose another or leave empty to auto-generate.",
  },
};
